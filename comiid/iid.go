...
var (
	...
	// IADsPropertyValue is the component object model identifier of the
	// IADsPropertyValue interface.
	//
	// IID_IADsPropertyValue
	// {79FA9AD0-A97C-11D0-8534-00C04FD8D503}
	IADsPropertyValue = uuid.UUID{0x79, 0xFA, 0x9A, 0xD0, 0xA9, 0x7C, 0x11, 0xD0, 0x85, 0x34, 0x00, 0xC0, 0x4F, 0xD8, 0xD5, 0x03}

	// IADsLargeInteger is the component object model identifier of the
	// IADsLargeInteger interface.
	//
	// IID_IADsLargeInteger
	// {9068270B-0939-11D1-8BE1-00C04FD8D503}
	IADsLargeInteger = uuid.UUID{0x90, 0x68, 0x27, 0x0B, 0x09, 0x39, 0x11, 0xD1, 0x8B, 0xE1, 0x00, 0xC0, 0x4F, 0xD8, 0xD5, 0x03}

	// IDirectorySearch is the component object model identifier of the
	// IDirectorySearch interface.
	//
	// IID_IDirectorySearch
	// {109BA8EC-92F0-11D0-A790-00C04FD8D5A8}
	IDirectorySearch = uuid.UUID{0x10, 0x9B, 0xA8, 0xEC, 0x92, 0xF0, 0x11, 0xD0, 0xA7, 0x90, 0x00, 0xC0, 0x4F, 0xD8, 0xD5, 0xA8}

	// IADsUser is the component object model identifier of the
	// IADsUser interface.
	// IID_IADsUser is defined as {3E37E320-17E2-11CF-ABC4-02608C9E7553}
	// https://docs.microsoft.com/en-in/windows/desktop/ADSI/iadsuser-property-methods
	IADsUser = uuid.UUID{0x3E, 0x37, 0xE3, 0x20, 0x17, 0xE2, 0x11, 0xCF, 0xAB, 0xC4, 0x02, 0x60, 0x8C, 0x9E, 0x75, 0x53}
)
